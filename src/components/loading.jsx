                ...
                <g id="dots">
                    <g id="dot3" style={{ '--delay': '0' }}>
                        <mask id="path-1-inside-1_12_2" fill="white">
                            <path fillRule="evenodd" clipRule="evenodd" d="M37 7H46V10H49V19H46V22H37V19H34V10H37V7Z" />
                        </mask>
                        <path fillRule="evenodd" clipRule="evenodd" d="M37 7H46V10H49V19H46V22H37V19H34V10H37V7Z" fill="#F7E901" />
                    ...
                    <g id="dot2" style={{ '--delay': '6' }}>
                        <mask id="path-3-inside-2_12_2" fill="white">
                            <path fillRule="evenodd" clipRule="evenodd" d="M54 7H63V10H66V19H63V22H54V19H51V10H54V7Z" />
                        </mask>
                        <path fillRule="evenodd" clipRule="evenodd" d="M54 7H63V10H66V19H63V22H54V19H51V10H54V7Z" fill="#F7E901" />
                    ...
                    <g id="dot1" style={{ '--delay': '12' }}>
                        <mask id="path-5-inside-3_12_2" fill="white">
                            <path fillRule="evenodd" clipRule="evenodd" d="M71 7H80V10H83V19H80V22H71V19H68V10H71V7Z" />
                        </mask>
                        <path fillRule="evenodd" clipRule="evenodd" d="M71 7H80V10H83V19H80V22H71V19H68V10H71V7Z" fill="#F7E901" />
